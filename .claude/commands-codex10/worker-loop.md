...
```bash
git rebase --abort
./.claude/scripts/codex10 fail-task $WORKER_ID $TASK_ID "Rebase conflict while syncing with origin/main; task requires allocator/architect reschedule or merge-fix follow-up."
